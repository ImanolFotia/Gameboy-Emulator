...
cpu::cpu()
{
    #define __func__ [&](U8 n8, U16 n16)->void
    #define o opcode
    addInstruction(o(0x00, "NOP"     , "None",  8, 1, {NOT_CHANGE, NOT_CHANGE, NOT_CHANGE, NOT_CHANGE, 0, 0, 0, 0}, __func__{PC += 1;}));
    addInstruction(o(0x01, "LD_BC16" , "LD"  , 12, 3, {NOT_CHANGE, NOT_CHANGE, NOT_CHANGE, NOT_CHANGE, 0, 0, 0, 0}, __func__{this->rB = n16 & 0xFF00; this->rC = n16 & 0x00FF; PC += 3;}));
    addInstruction(o(0x02, "LD_BCA"  , "LD"  ,  8, 1, {NOT_CHANGE, NOT_CHANGE, NOT_CHANGE, NOT_CHANGE, 0, 0, 0, 0}, __func__{PC += 1;}));
    addInstruction(o(0x03, "INC_BC"  , "INC" ,  8, 1, {NOT_CHANGE, NOT_CHANGE, NOT_CHANGE, NOT_CHANGE, 0, 0, 0, 0}, __func__{PC += 1;}));
    addInstruction(o(0x04, "INC_B"   , "INC" ,  4, 1, {DEFAULT, SET_ZERO, DEFAULT, NOT_CHANGE, 0, 0, 0, 0}, __func__{PC += 1;}));
    addInstruction(o(0x05, "DEC_B"   , "DEC" ,  4, 1, {DEFAULT, SET_ONE, DEFAULT, NOT_CHANGE, 0, 0, 0, 0}, __func__{PC += 1;}));
    addInstruction(o(0x06, "LD_B8"   , "LD"  ,  8, 2, {NOT_CHANGE, NOT_CHANGE, NOT_CHANGE, NOT_CHANGE,0,0,0,0}, __func__{PC += 2;}));
    addInstruction(o(0x07, "RL_CA"   , "RL"  ,  4, 1, {SET_ZERO, SET_ZERO, SET_ZERO, SET_ZERO, 0,0,0,0}, __func__{PC += 1;}));
    addInstruction(o(0x08, "LD_16SP" , "LD"  , 20, 3, {NOT_CHANGE, NOT_CHANGE, NOT_CHANGE, NOT_CHANGE, 0, 0, 0, 0}, __func__{PC += 3;}));
    addInstruction(o(0x09, "ADD_HLBC", "ADD" ,  8, 1, {NOT_CHANGE, SET_ZERO, DEFAULT, DEFAULT, 0, 0, 0, 0}, __func__{PC += 1;}));
    addInstruction(o(0x0A, "LD_ABC"  , "LD"  ,  8, 1, {NOT_CHANGE, NOT_CHANGE, NOT_CHANGE, NOT_CHANGE, 0,0,0,0}, __func__{PC += 1;}));
    addInstruction(o(0x0B, "DEC_BC"  , "DEC" ,  8, 1, {NOT_CHANGE, NOT_CHANGE, NOT_CHANGE, NOT_CHANGE, 0,0,0,0}, __func__{PC += 1;}));
    addInstruction(o(0x0C, "INC_C"   , "INC" ,  4, 1, {DEFAULT, SET_ZERO, DEFAULT, NOT_CHANGE,0,0,0,0}, __func__{PC += 1;}));
    addInstruction(o(0x0D, "DEC_C"   , "DEC" ,  4, 1, {DEFAULT, SET_ONE, DEFAULT, NOT_CHANGE, 0,0,0,0}, __func__{}));
    addInstruction(o(0x0E, "LD_C8"   , "LD"  ,  8, 2, {NOT_CHANGE, NOT_CHANGE, NOT_CHANGE, NOT_CHANGE, 0,0,0,0}, __func__{PC += 2;}));
    addInstruction(o(0x0F, "RRCA"    , "RR"  ,  4, 1, {SET_ZERO, SET_ZERO, SET_ZERO, DEFAULT, 0,0,0,0}, __func__{PC += 1;}));
...
{
    this->Instructions.insert(std::make_pair(o.getOpcode(), o));
}